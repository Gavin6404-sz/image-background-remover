...
> 积分单价 = 订阅制有效单价 × 1.1（高于订阅制 10%）

| 套餐 | 次数 | API 成本 | 售价 | 利润 | 利润率 |
|------|------|---------|------|------|--------|
| Starter | 10 次 | $1.20 | $5.00 | $3.80 | 76% |
| Standard | 30 次 | $3.60 | $11.99 | $8.39 | 70% |
| Bundle | 90 次 | $10.80 | $34.99 | $24.19 | 69% |

**单价对比**（以 Pro 订阅 $19.99/60次 = $0.333/次为基准）：
- 订阅制：$0.333/次
- 积分制：$0.366/次（+10%）
